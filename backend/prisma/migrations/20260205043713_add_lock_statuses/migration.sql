...
-- CreateEnum
CREATE TYPE "LockStatus" AS ENUM ('OPEN', 'CLOSED', 'LOCKED', 'SCHEDULED', 'CASCADE');
...
CREATE TABLE "User" (
    ...
    "isYoutubeMember" BOOLEAN NOT NULL DEFAULT false,
    "lastYoutubeSync" TIMESTAMP(3),
...
CREATE TABLE "Event" (
    ...
    "cascade_start_time" TIMESTAMP(3),
